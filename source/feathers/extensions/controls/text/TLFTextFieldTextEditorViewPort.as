...
*/
package feathers.extensions.controls.text
{
	 ...
	 */
	public class TLFTextFieldTextEditorViewPort extends TLFTextFieldTextEditor implements ITextEditorViewPort
	{
		/**
		 ...
		 * Constructor.
		 */
		public function TLFTextFieldTextEditorViewPort()
		{
			super();
			this.multiline = true;
			this.wordWrap = true;
		 ...
		 * @private
		 */
		override protected function commitStylesAndData(textField:TLFTextField):void
		{
